...
1. Crear un gráfico con `ggplot2` mostrando estas 4 series (hint: combo `pivot_longer` + `facet_wrap`).
1. Qué sucede si se intenta hacer lo mismo pero con los siguientes datos? Cual sería 
una posible solución?

```{r}
set.seed(123)

ddesempleo2 <- ddesempleo |> 
...
5. <span style="font-size: 25px;">😱😱😱😱😱</span>
